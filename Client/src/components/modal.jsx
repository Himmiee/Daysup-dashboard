...
const ModalComponent = (props) => {
  ...
  const { popup, setPopup } = ItemContext();
          ...
          <div className="body bg-white h-72 sm:h-36 rounded-t-3xl sm:rounded-t-none sm:rounded-b-md pt-5 sm:pt-4">
            ...
            <div className="flex justify-center sm:mt-0">
              <label>
                ...
                <textarea onChange={onChange} className="text-[12px] p-2 border-[1px] mt-1 border-gray-200" name="Details" placeholder="minimum of 12 letters" id="" cols="40" rows="2"></textarea>
              </label>
            </div>
